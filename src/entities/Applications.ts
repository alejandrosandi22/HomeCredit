...
@Index(
  "IX_Applications_Age_Contract",
  ["skIdCurr", "amtCredit", "daysBirth", "nameContractType", "target"],
  {}
)
@Index(
  "IX_Applications_Gender_Target",
  ["skIdCurr", "occupationType", "codeGender", "target", "amtCredit"],
  {}
)
@Index(
  "IX_Applications_Occupation_Credit",
  ["skIdCurr", "occupationType", "amtCredit", "target"],
  {}
)
...
export class Applications {
  ...
  @Column("nvarchar", { name: "TARGET", nullable: true, length: 50 })
  target: string | null;
